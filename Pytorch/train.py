...
with torch.no_grad():
    ...
    num_queries = min(50, test_nodes.numel())
    query_nodes = test_nodes[
        torch.randperm(test_nodes.numel(), device=device)[:num_queries]
    ]
